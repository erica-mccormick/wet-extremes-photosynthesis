...
def rf_explain_anom(features, name, search_iters):
    ...
    scores = cross_val_score(search, X, y, scoring = 'r2', cv = outer_cv)
    ...
    r = permutation_importance(reg, X, y, n_repeats=50, random_state=42)
...
events_iqr = pd.read_csv('events_iqr_NTPARTITIONING.csv')
...
if which_version == 'features':
    ...
    for i in total_combos:
        ...
        combo_count += 1
        print(r2['r2'])
        importances.to_csv('runs/rf_explain_anomaly/importances_all_notest_NTPARTITIONING.csv')
        performances.to_csv('runs/rf_explain_anomaly/performances_all_notest_NTPARTITIONING.csv')
    ...
    for i in site_combos:
        ...
        combo_count += 1
        print(r2['r2'])
        importances_site.to_csv('runs/rf_explain_anomaly/importances_site_notest_NTPARTITIONING.csv')
        performances_site.to_csv('runs/rf_explain_anomaly/performances_site_notest_NTPARTITIONING.csv')
    ...
    for i in storm_combos:
        ...
        combo_count += 1
        print(r2['r2'])
        importances_storm.to_csv('runs/rf_explain_anomaly/importances_storm_notest_NTPARTITIONING.csv')
        performances_storm.to_csv('runs/rf_explain_anomaly/performances_storm_notest_NTPARTITIONING.csv')
